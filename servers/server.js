...
// Neo4j credentials
const uri = process.env.NEO4J_SERVER_URL || 'bolt://resilmesh-sap-isim-neo4j:7687';
const user = process.env.NEO4J_USERNAME || 'neo4j';
const password = process.env.NEO4J_PASSWORD || 'supertestovaciheslo';
const driver = neo4j.driver(uri, neo4j.auth.basic(user, password));

const ISIM_API_BASE = (process.env.ISIM_API_URL || 'http://resilmesh-sap-isim-automation:5000') + '/api';
